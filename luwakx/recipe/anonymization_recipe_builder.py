...
https://github.com/ZentaLabs/LUWAKX/blob/main/docs/deidentification_conformance.md#6-deidentification-recipe-creation-pipeline-stage-4---5
"""
...
def make_recipe_file(recipes_to_process: List[str], recipe_folder: str, config: Optional[dict] = None) -> Optional[str]:
    ...
    - Recipe generation: https://github.com/ZentaLabs/LUWAKX/blob/main/docs/deidentification_conformance.md#61-recipe-builder-overview
    - Action translation: https://github.com/ZentaLabs/LUWAKX/blob/main/docs/deidentification_conformance.md#641-translation-logic-by-action
    """
    ...
    # See: https://github.com/ZentaLabs/LUWAKX/blob/main/docs/deidentification_conformance.md#55-custom-tag-templates
    # See configuration documentation: https://github.com/ZentaLabs/LUWAKX/blob/main/docs/deidentification_conformance.md#912-optional-configuration-options
    ...
    # See: https://github.com/ZentaLabs/LUWAKX/blob/main/docs/deidentification_conformance.md#62-deidentification-profiles
    recipe_column_map = {
    ...
    with open(output_file, 'w') as outfile, open(output_csv, 'w', newline='', encoding='utf-8') as csv_out:
        ...
        with open(input_standard_template, 'r') as csvfile:
            ...
            for row in reader:
                ...
                # See: https://github.com/ZentaLabs/LUWAKX/blob/main/docs/deidentification_conformance.md#514-nested-sequence-support
                group_val = row['Group']
                ...
                if final_action == 'keep':
                    # See keep action: https://github.com/ZentaLabs/LUWAKX/blob/main/docs/deidentification_conformance.md#641-translation-logic-by-action
                    line = f"KEEP {tag}\n"
                elif final_action == 'remove':
                    # See remove action: https://github.com/ZentaLabs/LUWAKX/blob/main/docs/deidentification_conformance.md#641-translation-logic-by-action
                    if name.lower() == 'private attributes':
                        remove_private = True
                    else:
                        line = f"REMOVE {tag}\n"
                elif final_action == 'blank':
                    # See blank action: https://github.com/ZentaLabs/LUWAKX/blob/main/docs/deidentification_conformance.md#641-translation-logic-by-action
                    # See blank implementation: https://github.com/ZentaLabs/LUWAKX/blob/main/docs/deidentification_conformance.md#632-blank-action---empty-value-generation
                    ...
                    # See replace action: https://github.com/ZentaLabs/LUWAKX/blob/main/docs/deidentification_conformance.md#641-translation-logic-by-action
                    # See replace implementation: https://github.com/ZentaLabs/LUWAKX/blob/main/docs/deidentification_conformance.md#631-replace-action---dummy-value-generation
                    ...
                    # See: https://github.com/ZentaLabs/LUWAKX/blob/main/docs/deidentification_conformance.md#641-translation-logic-by-action
                    line = f"REPLACE {tag} func:sq_keep_original_with_review\n"
                elif final_action == 'func:generate_hmacuid':
                    # See UID generation: https://github.com/ZentaLabs/LUWAKX/blob/main/docs/deidentification_conformance.md#641-translation-logic-by-action
                    ...
                    # See date shifting: https://github.com/ZentaLabs/LUWAKX/blob/main/docs/deidentification_conformance.md#641-translation-logic-by-action
                    line = f"JITTER {tag} func:generate_hmacdate_shift\n"
                elif final_action == 'func:clean_descriptors_with_llm':
                    # See LLM cleaning: https://github.com/ZentaLabs/LUWAKX/blob/main/docs/deidentification_conformance.md#641-translation-logic-by-action
                    line = f"REPLACE {tag} func:clean_descriptors_with_llm\n"
                elif final_action == 'func:generate_patient_id':
                    # See patient ID generation: https://github.com/ZentaLabs/LUWAKX/blob/main/docs/deidentification_conformance.md#641-translation-logic-by-action
                    line = f"REPLACE {tag} func:generate_patient_id\n"
                elif final_action == 'func:check_patient_age':
                    # See check patient age: https://github.com/ZentaLabs/LUWAKX/blob/main/docs/deidentification_conformance.md#641-translation-logic-by-action
                    line = f"REPLACE {tag} func:check_patient_age\n"
                elif final_action == 'clean_manually':
                    # See clean_manually action: https://github.com/ZentaLabs/LUWAKX/blob/main/docs/deidentification_conformance.md#641-translation-logic-by-action
                    # Note: clean_manually is used for unsupported profiles - see: https://github.com/ZentaLabs/LUWAKX/blob/main/docs/deidentification_conformance.md#31-overview
        ...
        _directives_ref = 'https://github.com/ZentaLabs/LUWAKX/blob/main/docs/deidentification_conformance.md#642-additional-recipe-directives'
        ...
        if 'basic_profile' in recipes_to_process:
            ...
            # See "If basic_profile is selected" paragraph in: https://github.com/ZentaLabs/LUWAKX/blob/main/docs/deidentification_conformance.md#642-additional-recipe-directives
        ...
        # See: https://github.com/ZentaLabs/LUWAKX/blob/main/docs/deidentification_conformance.md#7-deidentificationmethodcodesequence-attribute-injection-pipeline-stage-6
        ...
        csv_writer.writerow({'Tag': '(0012,0064)', 'Tag Name': _dcs_name, 'Action': 'REMOVE', 'Replacement Value': '', 'Rationale': 'https://github.com/ZentaLabs/LUWAKX/blob/main/docs/deidentification_conformance.md#7-deidentificationmethodcodesequence-attribute-injection-pipeline-stage-6'})

        # Handle private tags
        # See "Private tag handling" paragraph in: https://github.com/ZentaLabs/LUWAKX/blob/main/docs/deidentification_conformance.md#641-translation-logic-by-action
        ...
        if remove_private:
            ...
            # See: https://github.com/ZentaLabs/LUWAKX/blob/main/docs/deidentification_conformance.md#642-additional-recipe-directives
...
def _determine_final_action(actions, vr):
    ...
    See: https://github.com/ZentaLabs/LUWAKX/blob/main/docs/deidentification_conformance.md#65-action-priority-rules
    """
...
def set_values_to_zero(vr):
    ...
    See: https://github.com/ZentaLabs/LUWAKX/blob/main/docs/deidentification_conformance.md#631-replace-action---dummy-value-generation
    """
...
def set_empty_value(vr):
    ...
    See: https://github.com/ZentaLabs/LUWAKX/blob/main/docs/deidentification_conformance.md#632-blank-action---empty-value-generation
    """
