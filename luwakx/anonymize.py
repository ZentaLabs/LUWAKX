...
class LuwakAnonymizer:
    def __init__(self, config_path):
        ...
        - LuwakAnonymizer: https://github.com/ZentaLabs/LUWAKX/blob/main/docs/deidentification_conformance.md#922-core-classes-and-relationships
        - Configuration: https://github.com/ZentaLabs/LUWAKX/blob/main/docs/deidentification_conformance.md#91-configuration-file
        """
    ...
    def load_config(self):
        ...
        See conformance documentation:
        https://github.com/ZentaLabs/LUWAKX/blob/main/docs/deidentification_conformance.md#91-configuration-file
        """
        # Load config JSON
        try:
            with open(self.config_path, 'r') as f:
