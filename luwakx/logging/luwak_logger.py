...
- Log Files: https://github.com/ZentaLabs/LUWAKX/blob/main/docs/deidentification_conformance.md#81-output-files-generated-by-luwak
- Log Levels: https://github.com/ZentaLabs/LUWAKX/blob/main/docs/deidentification_conformance.md#935-log-files
- Configuration: https://github.com/ZentaLabs/LUWAKX/blob/main/docs/deidentification_conformance.md#912-optional-configuration-options
"""
...
def setup_logger(log_level: str = 'INFO', 
    ...
    See conformance documentation:
    - Log Levels: https://github.com/ZentaLabs/LUWAKX/blob/main/docs/deidentification_conformance.md#935-log-files
    - Logging Options: https://github.com/ZentaLabs/LUWAKX/blob/main/docs/deidentification_conformance.md#912-optional-configuration-options
    """
