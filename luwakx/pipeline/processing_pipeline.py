...
class ProcessingPipeline:
    ...
    - Pipeline Architecture: https://github.com/ZentaLabs/LUWAKX/blob/main/docs/deidentification_conformance.md#32-pipeline-architecture
    - Core Classes: https://github.com/ZentaLabs/LUWAKX/blob/main/docs/deidentification_conformance.md#922-core-classes-and-relationships
    """
    ...
    def run_full_pipeline(self) -> None:
        ...
        See conformance documentation:
        https://github.com/ZentaLabs/LUWAKX/blob/main/docs/deidentification_conformance.md#32-pipeline-architecture
        """
        if self.logger:
            self.logger.info(
