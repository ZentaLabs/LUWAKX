...
class MetadataExporter:
    ...
    def append_series_review_flags(self, review_flags_file: str,
        ...
        https://github.com/ZentaLabs/LUWAKX/blob/main/docs/deidentification_conformance.md#81-output-files-generated-by-luwak
        """
        if not rows:
            return

        from .review_flag_collector import ReviewFlagCollector  # same package
    ...
    def export_metadata_to_parquet(self, metadata_list: List[Dict[str, Any]],
        ...
        - Export Logic: https://github.com/ZentaLabs/LUWAKX/blob/main/docs/deidentification_conformance.md#81-output-files-generated-by-luwak
        """
        try:
