...
https://github.com/ZentaLabs/LUWAKX/blob/main/docs/deidentification_conformance.md#5-metadata-deideintification----tags-and-profiles-templates
"""
...
class TCIAPrivateDisposition(Enum):
    ...
    See: https://github.com/ZentaLabs/LUWAKX/blob/main/docs/deidentification_conformance.md#5411-retain-safe-private-option
    """
    KEEP = "k"
    OFFSET_TIME = "o"
    HASH_UID = "h"
...
class DICOMStandardActionCode(Enum):
    ...
    See: https://github.com/ZentaLabs/LUWAKX/blob/main/docs/deidentification_conformance.md#541-basic-application-confidentiality-profile---action-mapping-logic
    """
    X_REMOVE = "X"
    D_REPLACE = "D"
    Z_BLANK = "Z"
...
def read_tcia_csv(tcia_csv_path, tcia_url=None):
    ...
    https://github.com/ZentaLabs/LUWAKX/blob/main/docs/deidentification_conformance.md#52-private-tags-template
    ...
    if os.path.exists(tcia_csv_path):
        ...
        download_github_asset_by_tag(
            "ZentaLabs", "LUWAKX", "dicom-dictionaries", filename, archive_path
        )
...
def transform_row(row):
    ...
    See: https://github.com/ZentaLabs/LUWAKX/blob/main/docs/deidentification_conformance.md#525-tcia-data-processing
...
def rtn_safe_priv_opt(row):
    ...
    if disposition == TCIAPrivateDisposition.KEEP.value:
        # See keep action: https://github.com/ZentaLabs/LUWAKX/blob/main/docs/deidentification_conformance.md#531-keep
        return 'keep'
    elif disposition == TCIAPrivateDisposition.OFFSET_TIME.value:
        # See date shifting: https://github.com/ZentaLabs/LUWAKX/blob/main/docs/deidentification_conformance.md#535-date-shifting-funcgenerate_hmacdate_shift
        return 'func:generate_hmacdate_shift'
    elif disposition == TCIAPrivateDisposition.HASH_UID.value:
        # See UID generation: https://github.com/ZentaLabs/LUWAKX/blob/main/docs/deidentification_conformance.md#534-uid-generation-funcgenerate_hmacuid
...
def fetch_tcia_table1(url, output_csv=None, save_csv=False):
    ...
    See conformance documentation:
    https://github.com/ZentaLabs/LUWAKX/blob/main/docs/deidentification_conformance.md#51-standard-tags-template
...
def generate_basic_profile(final_df, doc_refs_dict):
    ...
    for idx, row in df.iterrows():
        ...
        if basic_profile == DICOMStandardActionCode.X_REMOVE.value:
            # See remove action: https://github.com/ZentaLabs/LUWAKX/blob/main/docs/deidentification_conformance.md#532-remove
            df.at[idx, 'Basic Prof.'] = 'remove'
            doc_refs_dict[idx].append("Basic: https://github.com/ZentaLabs/LUWAKX/blob/main/docs/deidentification_conformance.md#532-remove")
                
        elif basic_profile == DICOMStandardActionCode.K_KEEP.value:
            # See keep action: https://github.com/ZentaLabs/LUWAKX/blob/main/docs/deidentification_conformance.md#531-keep
            df.at[idx, 'Basic Prof.'] = 'keep'
            doc_refs_dict[idx].append("Basic: https://github.com/ZentaLabs/LUWAKX/blob/main/docs/deidentification_conformance.md#531-keep")
            ...
            if vr == 'UI':
                ...
                doc_refs_dict[idx].append("Basic: https://github.com/ZentaLabs/LUWAKX/blob/main/docs/deidentification_conformance.md#534-uid-generation-funcgenerate_hmacuid")
            ...
            # See replace action: https://github.com/ZentaLabs/LUWAKX/blob/main/docs/deidentification_conformance.md#534-replace
            # See dummy value generation: https://github.com/ZentaLabs/LUWAKX/blob/main/docs/deidentification_conformance.md#631-replace-action---dummy-value-generation
            # See VR-based mapping logic: https://github.com/ZentaLabs/LUWAKX/blob/main/docs/deidentification_conformance.md#541-basic-application-confidentiality-profile---action-mapping-logic (DICOM Code 'D')
            ...
            # See fixed datetime: https://github.com/ZentaLabs/LUWAKX/blob/main/docs/deidentification_conformance.md#538-fixed-datetime-funcset_fixed_datetime
            if vr in ['DA', 'DT', 'TM']:
                ...
                doc_refs_dict[idx].append("Basic: https://github.com/ZentaLabs/LUWAKX/blob/main/docs/deidentification_conformance.md#538-fixed-datetime-funcset_fixed_datetime, Same action and dummy values as KitwareMedical/dicomanonymizer - https://github.com/KitwareMedical/dicom-anonymizer")
            elif vr in ['UI']:
                # Note: Same action as KitwareMedical/dicomanonymizer - https://github.com/KitwareMedical/dicom-anonymizer
                df.at[idx, 'Basic Prof.'] = 'func:generate_hmacuid'
                doc_refs_dict[idx].append("Basic: https://github.com/ZentaLabs/LUWAKX/blob/main/docs/deidentification_conformance.md#534-uid-generation-funcgenerate_hmacuid, Same action as KitwareMedical/dicomanonymizer - https://github.com/KitwareMedical/dicom-anonymizer")
            elif vr == 'SQ':
                ...
                if final_ctp in ['@remove()', 'removed']:
                    df.at[idx, 'Basic Prof.'] = 'remove'
                    doc_refs_dict[idx].append("Basic: https://github.com/ZentaLabs/LUWAKX/blob/main/docs/deidentification_conformance.md#532-remove, Same action as TCIA - https://wiki.cancerimagingarchive.net/display/Public/Submission+and+De-identification+Overview")
                else:
                    df.at[idx, 'Basic Prof.'] = 'func:sq_keep_original_with_review'
                    doc_refs_dict[idx].append("Basic: https://github.com/ZentaLabs/LUWAKX/blob/main/docs/deidentification_conformance.md#641-translation-logic-by-action")
            elif vr in replace_tag:
                df.at[idx, 'Basic Prof.'] = 'replace'
                doc_refs_dict[idx].append("Basic: https://github.com/ZentaLabs/LUWAKX/blob/main/docs/deidentification_conformance.md#534-replace")
            ...
            # See blank action: https://github.com/ZentaLabs/LUWAKX/blob/main/docs/deidentification_conformance.md#533-blank
            # See VR-based mapping logic: https://github.com/ZentaLabs/LUWAKX/blob/main/docs/deidentification_conformance.md#541-basic-application-confidentiality-profile---action-mapping-logic (DICOM Code 'Z')
            # Check if VR is date/time related for date replacement
            if vr in ['DA', 'DT', 'TM']:
                # Note: Same action and dummy values as KitwareMedical/dicomanonymizer - https://github.com/KitwareMedical/dicom-anonymizer
                df.at[idx, 'Basic Prof.'] = 'func:set_fixed_datetime'
                ...
                doc_refs_dict[idx].append("Basic: https://github.com/ZentaLabs/LUWAKX/blob/main/docs/deidentification_conformance.md#533-blank")
            ...
            # See VR-based mapping logic: https://github.com/ZentaLabs/LUWAKX/blob/main/docs/deidentification_conformance.md#541-basic-application-confidentiality-profile---action-mapping-logic (Modality Dependent Codes)
            # Note: Same action as KitwareMedical/dicomanonymizer - https://github.com/KitwareMedical/dicom-anonymizer
            if vr in ['DA', 'DT', 'TM']:
                df.at[idx, 'Basic Prof.'] = 'func:set_fixed_datetime'
                doc_refs_dict[idx].append("Basic: https://github.com/ZentaLabs/LUWAKX/blob/main/docs/deidentification_conformance.md#538-fixed-datetime-funcset_fixed_datetime, Same action as KitwareMedical/dicomanonymizer - https://github.com/KitwareMedical/dicom-anonymizer")
            # Note: Same action as KitwareMedical/dicomanonymizer - https://github.com/KitwareMedical/dicom-anonymizer
            ...
            # Note: Same action as KitwareMedical/dicomanonymizer - https://github.com/KitwareMedical/dicom-anonymizer
                                   ...
                                   DICOMStandardActionCode.X_REMOVE_Z_BLANK.value]:
                df.at[idx, 'Basic Prof.'] = 'blank'
                doc_refs_dict[idx].append("Basic: https://github.com/ZentaLabs/LUWAKX/blob/main/docs/deidentification_conformance.md#533-blank, Same action as KitwareMedical/dicomanonymizer - https://github.com/KitwareMedical/dicom-anonymizer")
                ...
                if vr in ['OB', 'OW', 'OF', 'UN']:
                    ...
                    if final_ctp in ['@remove()', 'removed']:
                        ...
                        df.at[idx, 'Basic Prof.'] = 'func:sq_keep_original_with_review'
                        doc_refs_dict[idx].append("Basic: https://github.com/ZentaLabs/LUWAKX/blob/main/docs/deidentification_conformance.md#539-sq-keep-with-review-flag-funcsq_keep_original_with_review")
                # Note: Same action as KitwareMedical/dicomanonymizer - https://github.com/KitwareMedical/dicom-anonymizer
                else:
                    df.at[idx, 'Basic Prof.'] = 'replace'
                    doc_refs_dict[idx].append("Basic: https://github.com/ZentaLabs/LUWAKX/blob/main/docs/deidentification_conformance.md#534-replace, Same action as KitwareMedical/dicomanonymizer - https://github.com/KitwareMedical/dicom-anonymizer")
            else:
    ...
    # See patient ID generation: https://github.com/ZentaLabs/LUWAKX/blob/main/docs/deidentification_conformance.md#536-patient-id-generation-funcgenerate_patient_id
    for idx in df[(df['Group'] == '0010') & (df['Element'].isin(['0010', '0020']))].index:
        ...
        doc_refs_dict[idx].append("Basic: https://github.com/ZentaLabs/LUWAKX/blob/main/docs/deidentification_conformance.md#536-patient-id-generation-funcgenerate_patient_id")
...
def generate_retain_uid_profile(final_df, doc_refs_dict):
    ...
    See: https://github.com/ZentaLabs/LUWAKX/blob/main/docs/deidentification_conformance.md#542-retain-uids-option
    """
    # Make a copy to avoid modifying the original
    df = final_df.copy()
    ...
    for idx, row in df.iterrows():
        ...
        if profile == DICOMStandardActionCode.K_KEEP.value:
            ...
            doc_refs_dict[idx].append("Retain UIDs: https://github.com/ZentaLabs/LUWAKX/blob/main/docs/deidentification_conformance.md#531-keep")
        elif profile == "":
            continue
        else:
...
def generate_retain_patient_characteristics_profile(final_df, doc_refs_dict):
    ...
    See: https://github.com/ZentaLabs/LUWAKX/blob/main/docs/deidentification_conformance.md#545-retain-patient-characteristics-option
    """
    # Make a copy to avoid modifying the original
    df = final_df.copy()
    ...
    for idx, row in df.iterrows():
        ...
        if profile == DICOMStandardActionCode.K_KEEP.value:
            ...
            if group == '0010' and element == '1010':
                # See: https://github.com/ZentaLabs/LUWAKX/blob/main/docs/deidentification_conformance.md#539-patient-age-handling-funccheck_patient_age
                df.at[idx, 'Rtn. Pat. Chars. Opt.'] = 'func:check_patient_age'
                doc_refs_dict[idx].append("Retain Patient Characteristics: https://github.com/ZentaLabs/LUWAKX/blob/main/docs/deidentification_conformance.md#539-patient-age-handling-funccheck_patient_age")
            else:
                # See keep action: https://github.com/ZentaLabs/LUWAKX/blob/main/docs/deidentification_conformance.md#531-keep
                df.at[idx, 'Rtn. Pat. Chars. Opt.'] = 'keep'
                doc_refs_dict[idx].append("Retain Patient Characteristics: https://github.com/ZentaLabs/LUWAKX/blob/main/docs/deidentification_conformance.md#531-keep")
            ...
            if '@remove()' in final_ctp_script:
                ...
                doc_refs_dict[idx].append("Retain Patient Characteristics: https://github.com/ZentaLabs/LUWAKX/blob/main/docs/deidentification_conformance.md#532-remove, Same action as TCIA - https://wiki.cancerimagingarchive.net/display/Public/Submission+and+De-identification+Overview")
            else:
                ...
                doc_refs_dict[idx].append("Retain Patient Characteristics: https://github.com/ZentaLabs/LUWAKX/blob/main/docs/deidentification_conformance.md#537-llm-descriptor-cleaning-funcclean_descriptors_with_llm")
        elif profile == "":
            continue
        else:
...
def generate_retain_long_full_dates_profile(final_df, doc_refs_dict):
    ...
    See: https://github.com/ZentaLabs/LUWAKX/blob/main/docs/deidentification_conformance.md#546-retain-longitudinal-temporal-information-with-full-dates-option
    """
    # Make a copy to avoid modifying the original
    df = final_df.copy()
    ...
    for idx, row in df.iterrows():
        ...
        if profile == DICOMStandardActionCode.K_KEEP.value:
            ...
            doc_refs_dict[idx].append("Retain Full Dates: https://github.com/ZentaLabs/LUWAKX/blob/main/docs/deidentification_conformance.md#531-keep")
        elif profile == '':
            continue
        else:
...
def generate_retain_long_modified_dates_profile(final_df, doc_refs_dict):
    ...
    See: https://github.com/ZentaLabs/LUWAKX/blob/main/docs/deidentification_conformance.md#547-retain-longitudinal-temporal-information-with-modified-dates-option
    """
    # Make a copy to avoid modifying the original
    df = final_df.copy()
    ...
    for idx, row in df.iterrows():
        ...
        if profile == DICOMStandardActionCode.C_CLEAN.value:
            ...
            if str(row['VR']) == 'TM':
                ...
                doc_refs_dict[idx].append("Retain Modified Dates: https://github.com/ZentaLabs/LUWAKX/blob/main/docs/deidentification_conformance.md#535-date-shifting-funcgenerate_hmacdate_shift, Same action logic as TCIA - https://wiki.cancerimagingarchive.net/display/Public/Submission+and+De-identification+Overview")
            # Note: Same action as TCIA - https://wiki.cancerimagingarchive.net/display/Public/Submission+and+De-identification+Overview
            else:
                # For other VRs that can not be easily jittered, set to remove as a safe default
                # See remove action: https://github.com/ZentaLabs/LUWAKX/blob/main/docs/deidentification_conformance.md#532-remove
                df.at[idx, 'Rtn. Long. Modif. Dates Opt.'] = 'remove'
                doc_refs_dict[idx].append("Retain Modified Dates: https://github.com/ZentaLabs/LUWAKX/blob/main/docs/deidentification_conformance.md#532-remove, Same action as TCIA - https://wiki.cancerimagingarchive.net/display/Public/Submission+and+De-identification+Overview")
...
def retain_device_id_option(df, doc_refs_dict):
    ...
    See: https://github.com/ZentaLabs/LUWAKX/blob/main/docs/deidentification_conformance.md#543-retain-device-identity-option
    """
    # Make a copy to avoid modifying the original
    df = df.copy()
    ...
    for idx, row in df.iterrows():
        ...
        if profile == DICOMStandardActionCode.C_CLEAN.value:
            ...
            doc_refs_dict[idx].append("Retain Device ID: https://github.com/ZentaLabs/LUWAKX/blob/main/docs/deidentification_conformance.md#537-llm-descriptor-cleaning-funcclean_descriptors_with_llm")
        elif profile == DICOMStandardActionCode.K_KEEP.value:
            # See keep action: https://github.com/ZentaLabs/LUWAKX/blob/main/docs/deidentification_conformance.md#531-keep
            df.at[idx, 'Rtn. Dev. Id. Opt.'] = 'keep'
            doc_refs_dict[idx].append("Retain Device ID: https://github.com/ZentaLabs/LUWAKX/blob/main/docs/deidentification_conformance.md#531-keep")
        elif profile == '':
            continue
        else:
...
def retain_institution_id_option(df, doc_refs_dict):
    ...
    See: https://github.com/ZentaLabs/LUWAKX/blob/main/docs/deidentification_conformance.md#544-retain-institution-identity-option
    """
    # Make a copy to avoid modifying the original
    df = df.copy()
    ...
    for idx, row in df.iterrows():
        ...
        if profile == DICOMStandardActionCode.K_KEEP.value:
            ...
            doc_refs_dict[idx].append("Retain Institution ID: https://github.com/ZentaLabs/LUWAKX/blob/main/docs/deidentification_conformance.md#531-keep")
        elif profile == '':
            continue
        else:
...
def clean_profiles(df, doc_refs_dict):
    ...
    for idx, row in df.iterrows():
        ...
        if profile2 == DICOMStandardActionCode.C_CLEAN.value:
            ...
            # Note: Clean Structured Content Option is not automated in Luwak - see: https://github.com/ZentaLabs/LUWAKX/blob/main/docs/deidentification_conformance.md#31-overview
            df.at[idx, 'Clean Struct. Cont. Opt.'] = 'clean_manually'
            doc_refs_dict[idx].append("Clean Structured Content: https://github.com/ZentaLabs/LUWAKX/blob/main/docs/deidentification_conformance.md#641-translation-logic-by-action, Not automated in Luwak - https://github.com/ZentaLabs/LUWAKX/blob/main/docs/deidentification_conformance.md#31-overview")
        if profile3 == DICOMStandardActionCode.C_CLEAN.value:
            # See: https://github.com/ZentaLabs/LUWAKX/blob/main/docs/deidentification_conformance.md#5410-clean-graphics-option
            # clean_manually action requires manual review - see: https://github.com/ZentaLabs/LUWAKX/blob/main/docs/deidentification_conformance.md#641-translation-logic-by-action
            # Note: Clean Graphics Option is not automated in Luwak - see: https://github.com/ZentaLabs/LUWAKX/blob/main/docs/deidentification_conformance.md#31-overview
            df.at[idx, 'Clean Graph. Opt.'] = 'clean_manually'
            doc_refs_dict[idx].append("Clean Graphics: https://github.com/ZentaLabs/LUWAKX/blob/main/docs/deidentification_conformance.md#641-translation-logic-by-action, Not automated in Luwak - https://github.com/ZentaLabs/LUWAKX/blob/main/docs/deidentification_conformance.md#31-overview")
        if profile1 == '':
            continue
        if profile2 == '':
            continue
...
def create_final_file(final_df, output_csv):
    ...
    See: https://github.com/ZentaLabs/LUWAKX/blob/main/docs/deidentification_conformance.md#51-standard-tags-template
    """
    df = final_df.copy()
